...
@section('content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex">
        <h6 class="m-0 font-weight-bold text-primary"> {{ trans('defult.edit branch') }} </h6>
        <div class="ml-auto">
        ...
        <form action="{{ route('branches.update' , $branch->id) }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text"  name="name" value="{{$branch->getTranslation('name','ar')}}" class="form-control form-control-solid" placeholder="Enter name" >
                ...
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text"  name="name_en" value="{{$branch->getTranslation('name','en')}}" class="form-control form-control-solid" placeholder="Enter name" >
