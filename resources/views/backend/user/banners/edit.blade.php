...
@section('title')
{{ trans('defult.edit company-banner') }}
@endsection
...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary"> {{ trans('defult.edit company-banner') }} </h6>
            <div class="ml-auto">
                <a href="{{ route('company-banners.index') }}" class="btn btn-primary">
                <span><i class="fa fa-home"></i></span>
                <span> {{ trans('defult.company-banners') }} </span>
            </a>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('company-banners.update' , $banner->id) }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
               @method('PUT')
                @csrf
