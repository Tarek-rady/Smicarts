...
@section('content')
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            ...
            <a href="{{ route('company-complaints-export') }}" class="btn btn-success">
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="datatable">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted">
                            ...
                            <th class="min-w-150px">{{ trans('defult.authors'{{ trans('defult.message') }}) }}</th>
                            <th class="min-w-130px">{{ trans('defult.message') }}</th>
                            <th class="min-w-130px">{{ trans('defult.created_at') }}</th>
                        </tr>
                    </thead>
                    <!--end::Table head-->
                    <!--begin::Table body-->
                        ...
                        @foreach ($complaints as $complaint)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            ...
                                            @include('backend.user.complaints.seemore')
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <span class="text-dark fw-bolder text-hover-primary fs-6">{{ $complaint->created_at }}</span>
