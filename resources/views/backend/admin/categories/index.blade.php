    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{ trans('category.category') }}</span>
            </h3>
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
                <a href="{{ route('categories.create') }}" class="btn btn-primary">
                    <span><i class="fa fa-plus"></i></span>
                    <span>  {{ trans('category.add category') }} </span>
                </a>
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="datatable">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted">
                            ...
                            <th class="min-w-150px">{{ trans('category.category') }}</th>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-45px me-5">
                                            <img src="{{ asset('Attachments/categories/'.$category->img) }}" alt="" />
                                        </div>
                                        <div class="d-flex justify-content-start flex-column">
                                            <span class="text-dark fw-bolder text-hover-primary fs-6">{{ $category->name }}</span>
                                            <span class="text-muted fw-bold text-muted d-block fs-7">{{ $category->color }}</span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        ...
                                        @include('backend.admin.categories.delete')
