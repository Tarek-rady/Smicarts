...
@section('title')
{{ trans('subcategory.Edits subCategory') }}
@endsection
...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">{{ trans('subcategory.Edits subCategory') }} </h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('sub-categories.update' , $sub_category->id) }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                ...
                <div class="row">
                    <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <input type="text"  name="name" value="{{$sub_category->getTranslation('name','ar')}}" class="form-control form-control-solid" placeholder="Enter name" >
                    ...
                    <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <input type="text"  name="name_en" value="{{$sub_category->getTranslation('name','en')}}" class="form-control form-control-solid" placeholder="Enter name" >
                ...
                <div class="row">
                    ...
                    <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <input type="color"  name="color" value="{{ old('color' , $sub_category->color) }}" class="form-control form-control-solid" placeholder="Enter name" >
