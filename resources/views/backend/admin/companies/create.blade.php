...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex">
        <h6 class="m-0 font-weight-bold text-primary"> {{ trans('defult.add company') }} </h6>
        <div class="ml-auto">
        ...
        <form action="{{ route('companies.store') }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text"  name="company_name" value="{{ old('company_name') }}" class="form-control form-control-solid" placeholder="Enter Company name" >
                ...
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text"  name="company_name_en" value="{{ old('company_name_en') }}" class="form-control form-control-solid" placeholder="Enter name" >
            ...
            <div class="row">
                <div class="d-flex col-4 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text"  name="name" value="{{ old('name') }}" class="form-control form-control-solid" placeholder="Enter Admin name" >
                ...
                <div class="d-flex col-4 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="email"  name="email" value="{{ old('email') }}" class="form-control form-control-solid" placeholder="Enter Admin Email" >
            ...
            <div class="row">
                ...
                <div class="col-md-4 fv-row">
                    ...
                    <select class="form-select form-select-solid"  data-hide-search="true" data-placeholder="Select a cities" name="payment_type" id="payment_type">
                           ...
                           <option value="3">Both (Cash and Visa)</option>
                ...
                <div class="col-md-4 fv-row">
                    ...
                    <input type="price"  name="price" value="{{ old('price') }}" class="form-control form-control-solid" placeholder="Enter Price" >
