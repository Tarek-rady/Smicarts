    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1"> {{ trans('users.users') }}</span>
            </h3>
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
                <a href="{{ route('users.create') }}" class="btn btn-primary">
                    <span><i class="fa fa-plus"></i></span>
                    <span> {{ trans('users.add user') }} </span>
                </a>
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="datatable">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted">
                            ...
                            <th class="min-w-140px">{{ trans('users.email') }}</th>
                            <th class="min-w-130px">{{ trans('users.mobile') }}</th>
                        ...
                        @foreach ($users as $user)
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-45px me-5">
                                            <img src="{{ asset('Attachments/users/'.$user->img) }}" alt="" />
                                        </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <span class="text-dark fw-bolder text-hover-primary fs-6">{{ $user->mobile }}</span>
                                        </div>
                                    </div>
                                </td>
